package com.dashu.buyer.im.adapter;

import android.content.Context;
import android.view.View;

import com.dashu.buyer.R;
import com.dashu.buyer.im.adapter.base.BaseRecyclerAdapter;
import com.dashu.buyer.im.adapter.base.BaseRecyclerHolder;
import com.dashu.buyer.im.adapter.base.IMutlipleItem;
import com.dashu.buyer.im.bean.Conversation;
import com.dashu.buyer.im.util.TimeUtil;
...
public class ConversationAdapter extends BaseRecyclerAdapter<Conversation> {
    ...
    public void bindView(BaseRecyclerHolder holder, Conversation conversation, int position) {
        ...
        if (obj instanceof String) {
            ...
            holder.setImageView(avatar, R.mipmap.header, R.id.iv_recent_avatar);
        } else {
